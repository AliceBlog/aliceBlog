...
export const menuUrlJsonp = 'http://www.witdor.com/aliceBlog/api/menusJsonp.json';

export const technologyListUrl = 'http://www.witdor.com/aliceBlog/api/technologyList.php';
